...
\begin{itemize}
    ...
    \item \textbf{Cruce asintótico.} En $N = 256$ el resultado sigue siendo indistinguible: Strassen es más rápido en 2 de las 6 configuraciones y más lento en las otras 4, con diferencias de a lo sumo 1{,}2 ms sobre tiempos del orden de 5 ms, es decir, dentro del margen de ruido establecido. En $N = 1024$, en cambio, Strassen es más rápido en las 6 configuraciones, con razones de 1{,}07 a 2{,}01. El cruce práctico se sitúa así entre $N = 256$ y $N = 1024$, muy por encima del punto en que la ventaja teórica ($N^{2{,}81}$ frente a $N^{3}$) comienza a existir.
